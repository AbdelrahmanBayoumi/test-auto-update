...
public class UpdateHandler {
    ...
    public void showInstallPrompt() {
        Platform.runLater(() -> {
            ...
            Logger.info(getClass().getName() + ".showInstallPrompt(): " + "Current Version: " + version);
            Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
            alert.setTitle("New Update Available");
            alert.setHeaderText("New Update Available");
            alert.setContentText("A new version " + UpdateHandler.getInstance().getUpdateInfo().getVersion() + " is available for update: " + UpdateHandler.getInstance().getUpdateInfo().getFilename() + ". Url=" + UpdateHandler.getInstance().getUpdateInfo().getInstallerUrl());
            alert.showAndWait();
